        ...
        <div class="w-4/12 bg-white p-6 rounded-lg">
            <form action="{{ route('register') }}" method="post">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="username" id="username" placeholder="Create Username" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('username') border-red-500 @enderror" value="{{ old('username') }}">
                ...
                <div>
                    <button type="submit" class="bg-red-500 text-white px-4 py-3 rounded font-medium w-full">Register</button>
                </div>
            </form>
        </div>
    </div>
